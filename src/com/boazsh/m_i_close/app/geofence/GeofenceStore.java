...
import com.boazsh.m_i_close.app.activities.MainActivity;
...
public class GeofenceStore {
     ...
     * {@link GeofenceWrapper}
     */
    
    public Location getSimpleGeofenceLocation() {
    	
    	double lat = mPrefs.getFloat(
                getGeofenceFieldKey(GeofenceUtils.KEY_LATITUDE),
        ...
        double lng = mPrefs.getFloat(
                getGeofenceFieldKey(GeofenceUtils.KEY_LONGITUDE),
                GeofenceUtils.INVALID_FLOAT_VALUE);
        
        Location location = new Location("MIClose Provider");
    ...
    public GeofenceWrapper getGeofence() {
        ...
        float radius = mPrefs.getFloat(
                getGeofenceFieldKey(GeofenceUtils.KEY_RADIUS),
                GeofenceUtils.INVALID_FLOAT_VALUE);
        ...
        long expirationDuration = mPrefs.getLong(
                getGeofenceFieldKey(GeofenceUtils.KEY_EXPIRATION_DURATION),
        ...
        int transitionType = mPrefs.getInt(
                getGeofenceFieldKey(GeofenceUtils.KEY_TRANSITION_TYPE),
        ...
        if (
            ...
            return new GeofenceWrapper(lat, lng, radius, expirationDuration, transitionType);
     ...
     * @param geofence The {@link GeofenceWrapper} containing the
     * values you want to save in SharedPreferences
     */
    public void setGeofence(GeofenceWrapper geofence) {
    ...
    public void clearGeofence(String id) {
        ...
        Editor editor = mPrefs.edit();
        editor.remove(getGeofenceFieldKey(GeofenceUtils.KEY_LATITUDE));
        editor.remove(getGeofenceFieldKey(GeofenceUtils.KEY_LONGITUDE));
        editor.remove(getGeofenceFieldKey(GeofenceUtils.KEY_RADIUS));
        editor.remove(getGeofenceFieldKey(GeofenceUtils.KEY_EXPIRATION_DURATION));
        editor.remove(getGeofenceFieldKey(GeofenceUtils.KEY_TRANSITION_TYPE));
        editor.commit();
    }
